...
// Wed Dec 29 09:47:37 2021 by ROOT version 6.12/07
// from TTree Events/Events
// found on file: 1F555B22-8D51-134A-9A22-56EBBB62A9E6.root
//////////////////////////////////////////////////////////
...
public :
  ...
  //The gen-level information (not available in data) are pushed back to towards the end.
  ...
  //Jets (Note : Data also has JetCalo, JetPuppy and FatJetCHS)
  ...
  //After this, data has proton variables
  ...
  TTreeReaderValue<Bool_t> Flag_HBHENoiseFilter = {fReader, "Flag_HBHENoiseFilter"};//Important
  TTreeReaderValue<Bool_t> Flag_HBHENoiseIsoFilter = {fReader, "Flag_HBHENoiseIsoFilter"};//Important
  ...
  TTreeReaderValue<Bool_t> Flag_globalSuperTightHalo2016Filter = {fReader, "Flag_globalSuperTightHalo2016Filter"};//Important
  ...
  TTreeReaderValue<Bool_t> Flag_EcalDeadCellTriggerPrimitiveFilter = {fReader, "Flag_EcalDeadCellTriggerPrimitiveFilter"};//Important
  ...
  TTreeReaderValue<Bool_t> Flag_goodVertices = {fReader, "Flag_goodVertices"};//Important
  TTreeReaderValue<Bool_t> Flag_eeBadScFilter = {fReader, "Flag_eeBadScFilter"};//Important
  ...
  TTreeReaderValue<Bool_t> Flag_BadPFMuonFilter = {fReader, "Flag_BadPFMuonFilter"};//Important
  ...
  */
  ...
  //BRANCHES NOT AVAILABLE IN DATA
  ...
  //##################################################################################
  // The following branches are in MC only. Therefore, I am using a different fReader.
  // freader_MC is activated in the Init() function when _data == 0
  //#################################################################################
  ...
  double getScaleFactors_Muons_Reco_preVFP(float eta, float pt);
  double getScaleFactors_Muons_Reco_postVFP(float eta , float pt);
  double getScaleFactors_Muons_ID(float eta , float pt);
  double getScaleFactors_Muons_Iso(float eta , float pt);
  double getEfficiency_Muons_Trigger(float eta , float pt);
  double getScaleFactors_Electrons_Reco(float eta , float pt);
  double getScaleFactors_Electrons_IDIso(float eta , float pt);
...
private:
  ...
  int nEvtTotal,nEvtRan, nCount4L, nCount2L2L, nCount2L, nCount3L, nCount_LHEweight_pos, nCount_LHEweight_neg;
  ...
  //Declare arrays here:
  vector<Lepton> GenEle, GenMu, GoodMu, GoodMu_pos, GoodMu_neg, llep, GoodEle, GoodJet, bJet, GoodTau, pairing1, pairing2, pairing3;
  vector<float> MassArray_chosen, MassArray_unchosen, MassArray_2e2mu, MassArray_4L;
